/*  Macro to run Cellpose on an image or active (rectangular) selection and display the segmentation as overlay.
...
if(displayOverlay == true) {
	...
	if(useSelection == true) {
		Overlay.moveSelection(0, x, y);	//Move the overlay to the location of the selection 
